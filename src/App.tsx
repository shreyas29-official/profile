  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      >
        <div className="text-center">
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl text-gray-300 mb-8"
          >
            Full Stack Developer, Android App Developer, AIML Enthusiast
          </motion.p>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="h-40 bg-purple-900/30 rounded-lg mb-4 flex items-center justify-center">
                <Code size={64} className="text-purple-400" />
              </div>
              <h3 className="text-xl font-semibold mb-2 text-purple-400">React Basic</h3>
              <p className="text-gray-300 mb-4">HackerRank</p>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">2025</span>
                <a href="https://www.hackerrank.com/certificates/cdc35e3e504d" className="text-purple-400 hover:text-purple-300">
                  <ExternalLink size={20} />
                </a>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-purple-400">SQL Basic</h3>
              <p className="text-gray-300 mb-4">HackerRank</p>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">2025</span>
                <a href="https://www.hackerrank.com/certificates/39846c2495c9" className="text-purple-400 hover:text-purple-300">
                  <ExternalLink size={20} />
                </a>
              </div>
            </motion.div>

            {/* Software Engineering Intern Certificate */}
            <motion.div
              variants={fadeInUp}
              className="bg-gray-800 rounded-lg p-6 transform hover:scale-105 transition-transform"
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-purple-400">Software Engineering Intern</h3>
              <p className="text-gray-300 mb-4">HackerRank</p>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">2025</span>
                <a href="https://www.hackerrank.com/certificates/3c81f4ea1f80" className="text-purple-400 hover:text-purple-300">
                  <ExternalLink size={20} />
                </a>
              </div>
            </motion.div>

            {/* Verizon Cloud Simulation Platform */}
            <motion.div
              variants={fadeInUp}
              className="bg-gray-800 rounded-lg p-6 transform hover:scale-105 transition-transform"
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-purple-400">Cloud Simulation Platform</h3>
              <p className="text-gray-300 mb-4">Verizon</p>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">2025</span>
                {/* <a href="" className="text-purple-400 hover:text-purple-300">
                  <ExternalLink size={20} />
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-purple-400">Advanced Software Engineering</h3>
              <p className="text-gray-300 mb-4">Walmart (Forage)</p>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">2025</span>
                {/* <a href="#" className="text-purple-400 hover:text-purple-300">
                  <ExternalLink size={20} />
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
        className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/50 to-pink-900/50"
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            whileHover={{ scale: 1.05 }}
          ...
          >
            <a
              href="/profile/Shreyasm_resume.pdf"
              className="inline-flex items-center px-8 py-4 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition-colors shadow-lg"
            >
