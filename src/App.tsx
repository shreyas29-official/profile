        ...
        <div className="space-y-6 text-left">
          <div>
            <h4 className="text-purple-400 font-medium mb-2 flex items-center">
              <img src="/prog.png" alt="Programming" className="w-5 h-5 mr-2" />
          ...
          <div>
            <h4 className="text-purple-400 font-medium mb-2 flex items-center">
              <img src="/fr.jpg" alt="Frameworks" className="w-5 h-5 mr-2" />
          ...
          <div>
            <h4 className="text-purple-400 font-medium mb-2 flex items-center">
              <img src="/tools.png" alt="Tools" className="w-5 h-5 mr-2" />
              Tools & Technologies
            </h4>
            <p className="text-gray-300 ml-7">
